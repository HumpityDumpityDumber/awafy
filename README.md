# AWAfy
AWAfy is a music daemon that streams music from [AWA](https://awa.fm/) and uses [AWA Lounge](http://app.awa.fm/) to allow for an online server synced queue experience. Made to be controlled through the web or app lounge interface.
